...
<section class="section-slide">
	<div class="wrap-slick1">
		<div class="slick1">
			<div class="item-slick1" style="background-image: url({{asset('FrontEnd')}}/market/images/slide-11.jpg);">
				<div class="container h-full">
					<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
						<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
							<span class="ltext-101 cl2 respon2" style="color:beige">
								Accessories Collection 2019
							</span>
						</div>
							
						<div class="layer-slick1 animated visible-false" data-appear="fadeInUp" data-delay="800">
							<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1" style="color:beige">
								NEW SEASON
							</h2>
						</div>
			...
			<div class="item-slick1" style="background-image: url({{asset('FrontEnd')}}/market/images/slide-09.jpg);">
				<div class="container h-full">
					<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
						<div class="layer-slick1 animated visible-false" data-appear="rollIn" data-delay="0">
							<span class="ltext-101 cl2 respon2" style="color:beige">
								Mobiles Collection 2019
							</span>
						</div>
			...
			<div class="item-slick1" style="background-image: url({{asset('FrontEnd')}}/market/images/slide-010.jpg);">
				<div class="container h-full">
					<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
						<div class="layer-slick1 animated visible-false" data-appear="rotateInDownLeft" data-delay="0">
							<span class="ltext-101 cl2 respon2" style="color:beige">
								Cameras Collection 2019
							</span>
						</div>
		...
		<div class="row">
			<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
				...
				<div class="block1 wrap-pic-w">
					<img src="{{asset('FrontEnd')}}/market/images/banner-01.jpg" alt="IMG-BANNER">
			...
			<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="{{asset('FrontEnd')}}/market/images/banner-02.jpg" alt="IMG-BANNER">
			...
			<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="{{asset('FrontEnd')}}/market/images/banner-03.jpg" alt="IMG-BANNER">
