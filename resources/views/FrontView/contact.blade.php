...
<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('{{asset('FrontEnd')}}/market/images/bg-01.jpg');">
        ...
        <div class="flex-w flex-tr">
            <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                <form>
                    ...
                    <img class="how-pos4 pointer-none" src="{{asset('FrontEnd')}}/market/images/icons/icon-email.png" alt="ICON">
                    </div>
