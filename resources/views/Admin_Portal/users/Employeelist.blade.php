                ...
                <div class="table-responsive tb" style="border-radius:10px;" >
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <th scope="row" id="userid">{{$employee->id}}</th>
                                    <td>{{$employee->name}}</td>
                                ...
                                <td>Employee</td>
                                    ...
                                    <td>
                                        ...
                                        <button type="submit" class="btn btn-primary edit" value="{{$employee->id}}" id="edit">
                                            <a href="/employees/{{ $employee->id }}/edit" style="color: white;">Edit</a>
                                        </button>
                                    </td>
                                    <td><button type="button" class="btn btn-danger delete" value="{{ $employee->id }}">Delete</button></td>
