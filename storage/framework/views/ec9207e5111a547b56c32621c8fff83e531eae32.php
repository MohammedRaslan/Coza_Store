            ...
            <div class="table-responsive tb" style="border-radius:10px;">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <th scope="row" id="userid"><?php echo e($product->id); ?></th>
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categ): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($product->categ == $categ->id): ?>
                        <td><?php echo e($categ->categ_name); ?></td>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td><?php echo e($product->price); ?></td>
                                ...
                                <td>
                                    ...
                                    <button type="submit" class="btn btn-primary edit" value="<?php echo e($product->id); ?>" id="edit">
                                        <a href="/products/<?php echo e($product->id); ?>/edit" style="color: white;">Edit</a>
                                    </button>
                                </td>
                                <td><button type="button" class="btn btn-danger deletepro" value="<?php echo e($product->id); ?>">Delete</button></td>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.fail) {
                        ...
                        //$('#preview_image').attr('src', '<?php echo e(asset('uploads')); ?>/' + data);
                    }
